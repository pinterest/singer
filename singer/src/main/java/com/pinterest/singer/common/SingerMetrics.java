...
public class SingerMetrics {
  ...
  public static final String KUBE_SERVICE_SECURE_CONNECTION_ERROR = KUBE_PREFIX + "kubeservice_secure_connection_error";
  ...
  public static final String POD_DIRECTORIES_DELETED = KUBE_PREFIX + "pod_directories_deleted";
