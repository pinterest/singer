...
public class SingerRestartTest {
  ...
  private static void printUsageAndExit() {
    System.err.println("USAGE: java " + SingerEndToEndTest.class.getName()
        + " rotateThresholdKiloBytes  batchSize   numTestMessages ");
    System.exit(1);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    SingerRestartTest test = new SingerRestartTest();
  ...
  public void testLoggingWithAudit() throws Exception {
    ...
    SingerAuditMessageReader auditMessageReader =
        new SingerAuditMessageReader(auditTopic, testStartTimestamp);
    ...
    singerProc = SingerTestHelper
        .startSingerProcess(singerBinaryDir, singerConfigDir, SingerEndToEndTest.class);

    outputRetriever = new SingerOutputRetriever(singerProc.getErrorStream());
    outputRetriever.start();
